...
<div class="ml-48 p-8">
    <div class="bg-[#6A62C4] rounded-full w-100 inline-block align-middle p-2">
        <span class="text-1xl font-semibold text-white">Dashboard Report </span>
    </div>
...
<h1>Jumlah Transaksi Pemesanan Obat  {{ $periode }} : {{ $reports->transaction_count }}</h1> 
<h1>Jumlah User Register  {{ $periode }} : {{ $reports->user_count }}</h1> 
